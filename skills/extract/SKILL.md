---
name: extract
description: Extract the current stable source queue through Scholar tools.
---
...
1. Call `scholar_get_extract_context` once. It lists the stable queue and gives each prepared immutable extraction record; do not inspect or claim a source outside that response.
